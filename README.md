...
## 📖 Description
This is a simple Python program that collects personal information from the user and displays it along with data types and memory addresses. It also calculates an approximate birth year.
